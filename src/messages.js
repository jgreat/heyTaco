 ...
 * @param {number} score     The item's current score. Defaults to 0 if not supplied.
 *
...
const getRandomMessage = ( operation, item, score = 0 ) => {
  ...
  switch ( operation ) {
    case operations.PLUS:
      format = '<message> *<item>* now has <score> :taco:.';
      break;
  ...
  return format.replace( '<item>', helpers.maybeLinkItem( item ) )
