 ...
 * @param {Function|object} options  Optionally, an object with one or more properties that control
 ...
 * @param {Function|string} callback Required. A function to call on completion of the run.
